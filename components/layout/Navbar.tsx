    ...
    <header className={cn(
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/cart" className={cn(buttonVariants({ variant: "default" }), "gap-2 h-10 px-4 rounded-none font-bold tracking-widest shadow-sm")}>
          ...
          <Button
            variant="outline"
            className="md:hidden rounded-none border-stone-gray bg-transparent text-text-primary hover:bg-bg-panel h-10 w-10 p-0"
