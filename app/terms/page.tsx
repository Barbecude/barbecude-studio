  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 text-left font-sans animate-fade-in">
      ...
      <div className="text-text-secondary space-y-6 leading-relaxed">
        ...
        <p>Dengan melakukan pembelian dan menggunakan platform ini, Anda menyetujui seluruh ketentuan layanan di bawah ini.</p>
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-4 uppercase tracking-wider  tracking-wider">1. Ketersediaan Produk</h2>
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-4 uppercase tracking-wider  tracking-wider">2. Pembayaran</h2>
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-4 uppercase tracking-wider  tracking-wider">3. Hak Cipta</h2>
