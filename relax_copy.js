...
const replacements = {
    ...
    "Diukir presisi sepenuhnya dari satu balok kayu pinus padat premium tanpa sambungan. Dirancang minimalis sebagai pelindung elegan meja kerja Anda.": "Dibuat dari kayu pinus premium. Desain minimalis, cocok banget buat nemenin meja kerjamu.",
    "Harga Resmi": "Harga",
    "Beli Sekarang": "Bungkus Sekarang",
    "Lihat Semua Koleksi": "Cek Semua Barang",
    "Koleksi Termurah Kami": "Paling Ramah di Kantong",
    "Mahakarya Meja Anda": "Pajangan Keren Buat Mejamu",
    "Selengkapnya": "Cek Detail",
    "Pesan Sekarang": "Bungkus Sekarang",
    "Tambah ke Keranjang": "Masukin Keranjang",
    "Syarat & Ketentuan": "Aturan Main",
    "Piksel mini pelengkap perjalanan harian Anda.": "Aksesoris kece buat nemenin aktivitasmu.",
    ...
    "Temukan kerajinan kayu premium yang diadaptasi dari blok ikonik kesayangan Anda.": "Temuin berbagai kerajinan kayu premium dari game favoritmu di sini.",
    ...
    "Keranjang Anda kosong.": "Keranjangmu masih kosong nih.",
    ...
    "Dukung perjalanan server Anda dengan kredit instan yang aman.": "Isi kreditmu di sini, aman dan instan pastinya.",
    "Infrastruktur Server": "Spesifikasi Server",
    "Hosting Berperforma Tinggi": "Hosting Super Ngebut",
    "Sewa node tangguh untuk komunitas Anda dengan uptime 99.9%.": "Sewa server kenceng buat mabar, dijamin lancar tanpa lag.",
    ...
    "Produk": "Barang",
    "Dimensi": "Ukuran",
    "Pilih server dan masukkan username karakter Anda.": "Pilih server dan masukin username kamu.",
